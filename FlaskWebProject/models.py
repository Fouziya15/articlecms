...
blob_service = BlobServiceClient(
    account_url=f"https://<your_storage_account>.blob.core.windows.net",
            ...
            try:
                ...
                if self.image_path:
                    try:
                        ...
                        flash(f"Could not delete old blob: {str(e)}")

            except Exception as e:
                flash(f"Blob upload error: {str(e)}")
